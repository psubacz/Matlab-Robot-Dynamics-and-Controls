...
k2 = (m1*v2s*0.5)+(I1*(diff(th1,t)+diff(th2,t))^2*0.5);
KE = simplify(k1+k2);
...
torq1 = diff(subs(diff(subs(L,aP,sP),td1r),sP,aP),t) - subs(diff(subs(L,aP,sP),td1r),sP,aP);
torq2 = diff(subs(diff(subs(L,aP,sP),td2r),sP,aP),t) - subs(diff(subs(L,aP,sP),td2r),sP,aP);
...
G = subs(torques,{diff(theta1(t),t,t),diff(theta2(t),t,t),diff(theta1(t),t,t),diff(theta2(t),t)},{0,0,0,0})
