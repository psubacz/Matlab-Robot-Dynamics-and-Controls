...
function []= Problem3()
    ...
    set(legend,'Position',[0.7 0.3 0.2 0.15]);
    ylabel('rad/s')
    xlabel('time')
...
%% Functions
    function [dx] = plannarArmODE(t,x)
        ...
        tau = ComputedTorqueController(theta_d, dtheta_d, ddtheta_d,...
            theta, dtheta);
    ...
    function tau =ComputedTorqueController(theta_d, dtheta_d,ddtheta_d, theta, dtheta)
        global Mmat Cmat
